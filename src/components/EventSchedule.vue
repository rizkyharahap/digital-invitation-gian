...
<template>
  <div class="relative">
    ...
    >
      <div
        class="reveal flex w-full flex-col items-center gap-4 rounded-2xl bg-[#FBFBFB80] px-5 py-6 text-center"
      >
        ...
        <div class="flex flex-col gap-2">
          <strong class="text-base">Minggu, 12 Januari 2025</strong>
